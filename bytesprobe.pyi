...
def count(data: bytes | bytearray | memoryview) -> int: ...

def pair_count(first: bytes | bytearray | memoryview, second: bytes | bytearray | memoryview) -> int: ...

def echo(data: bytes | bytearray | memoryview) -> bytes: ...

__all__: list[str] = ["count", "pair_count", "echo", "ElisaError"]
