...
def roundtrip(values: Mapping[str | bytes, str | bytes]) -> dict[str, str]: ...

def roundtrip_points(values: Mapping[str | bytes, Point | PointInput]) -> dict[str, Point]: ...

def count(values: Mapping[str | bytes, int]) -> int: ...

__all__: list[str] = ["roundtrip", "roundtrip_points", "count", "ElisaError", "Point"]
