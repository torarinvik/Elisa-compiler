...
class MaybeError(ElisaError):
    payload: None

class MaybePayloadError(ElisaError):
    payload: int

def value(value: int) -> int | None: ...
# raises MaybeError

def flag(value: int) -> bool | None: ...
# raises MaybeError

def payload(value: int) -> int | None: ...
# raises MaybePayloadError
# error payload: int

__all__: list[str] = ["value", "flag", "payload", "MaybeError", "MaybePayloadError", "ElisaError"]
