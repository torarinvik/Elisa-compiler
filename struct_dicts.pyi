...
class DictBundle(TypedDict):
    numbers: dict[int, int]
    nested: dict[str, list[int]]
    objects: dict[str, Any | None]

class DictBundleInput(Protocol):
    numbers: Mapping[int, int]
    nested: Mapping[str | bytes, Sequence[int]]
    objects: Mapping[str | bytes, Any | None]

def echo(bundle: DictBundle | DictBundleInput) -> DictBundle: ...

__all__: list[str] = ["echo", "ElisaError", "DictBundle"]
