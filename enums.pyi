...
def mode_roundtrip(mode: int) -> int: ...

def plain_roundtrip(value: int) -> int: ...

def mode_count(values: Sequence[int]) -> int: ...

__all__: list[str] = ["mode_roundtrip", "plain_roundtrip", "mode_count", "ElisaError"]
