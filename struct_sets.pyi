...
class SetBundle(TypedDict):
    numbers: set[int]
    labels: set[str]
    views: set[str]

class SetBundleInput(Protocol):
    numbers: Iterable[int]
    labels: Iterable[str | bytes]
    views: Iterable[str | bytes]

def echo(bundle: SetBundle | SetBundleInput) -> SetBundle: ...

__all__: list[str] = ["echo", "ElisaError", "SetBundle"]
