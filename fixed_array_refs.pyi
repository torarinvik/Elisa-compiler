...
def sum_fixed(xs: Sequence[int]) -> int: ...

def sum_fixed_postfix(xs: Sequence[int]) -> int: ...

def sum_fixed_value(xs: Sequence[int]) -> int: ...

def sum_darray_ref(xs: Sequence[int]) -> int: ...

__all__: list[str] = ["sum_fixed", "sum_fixed_postfix", "sum_fixed_value", "sum_darray_ref", "ElisaError"]
