...
**Verified current Gen2 rebuild (2026-09-25):** `scripts/self_host_gen2.sh build/self_host_gen2_field_refinement` passed its runtime fixture using fresh Stage1 SHA-256 `c680fd566bb40791c5d5768c2c5d4db4adc3a6ba187f1ef76961d5520459447c` and produced Gen2 SHA-256 `7d01d59f65cd1927fb749a89b88d6a7107356dee6d13572f1be7d19363455e23`. The expanded `struct_field_refinement_shadow_smoke.sh` also passes against that Gen2 binary. This confirms the checker rebuilds and preserves the tested Stage1 behavior at Gen2; it does not close the interval-only proof model, alias identity, non-interval refinements, FFI trust boundaries, or the broader S15 acceptance gate.
