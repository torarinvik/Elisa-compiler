...
- This closes the reproduced current/enclosing-relative declaration-tree alias bypass for the tested representation families. Keep S04/S10/S15 open for Stage0 parity; import/`using` aliases; same-name shadowing, reopened modules, and lookup-precedence matrices; aliases nested in aggregate fields or generic substitutions; enum and other niche/tag layouts; untested assignment/return/call boundaries; complete path-sensitive initialization; and the canonical TypeId-based resolved-representation service. Add focused precedence and shadowing cases before extending this syntax-level resolver to more representation families.
