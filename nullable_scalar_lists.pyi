...
def optional_signed(values: Sequence[int | None]) -> list[int | None]: ...

def optional_unsigned(values: Sequence[int | None]) -> list[int | None]: ...

def optional_bool(values: Sequence[bool | None]) -> list[bool | None]: ...

def optional_float(values: Sequence[float | None]) -> list[float | None]: ...
