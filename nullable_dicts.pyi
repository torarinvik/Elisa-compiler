...
def optional_objects(values: Mapping[str | bytes, Any | None]) -> dict[str, Any | None]: ...

def optional_text(values: Mapping[str | bytes, str | bytes | None]) -> dict[str, str | None]: ...

def optional_view(values: Mapping[str | bytes, str | bytes | None]) -> dict[str, str | None]: ...

__all__: list[str] = ["optional_objects", "optional_text", "optional_view", "ElisaError"]
