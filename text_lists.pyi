...
def count(values: Sequence[str | bytes]) -> int: ...

def echo(values: Sequence[str | bytes]) -> list[str]: ...

def echo_cstr(values: Sequence[str | bytes]) -> list[str]: ...

__all__: list[str] = ["count", "echo", "echo_cstr", "ElisaError"]
