...
class Payload(TypedDict):
    values: dict[int, list[list[int]]]

class PayloadInput(Protocol):
    values: Mapping[int, Sequence[Sequence[int]]]

def roundtrip(value: Payload | PayloadInput) -> Payload: ...

__all__: list[str] = ["roundtrip", "ElisaError", "Payload"]
