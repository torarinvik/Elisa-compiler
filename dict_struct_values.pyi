...
class CatalogInput(Protocol):
    values: Mapping[str | bytes, Point | PointInput]

def roundtrip(values: Mapping[str | bytes, Point | PointInput]) -> dict[str, Point]: ...

def roundtrip_catalog(catalog: Catalog | CatalogInput) -> Catalog: ...

__all__: list[str] = ["roundtrip", "roundtrip_catalog", "ElisaError", "Point", "Catalog"]
