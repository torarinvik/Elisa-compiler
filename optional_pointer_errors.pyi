...
class MaybePointerError(ElisaError):
    payload: None

def text(value: int) -> str | None: ...
# raises MaybePointerError

def object(value: Any | None = None) -> Any | None: ...
# raises MaybePointerError

__all__: list[str] = ["text", "object", "MaybePointerError", "ElisaError"]
