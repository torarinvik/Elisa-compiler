...
class BadConfigInput(Protocol):
    pass
    # optional attribute 'values': Sequence[int]

def roundtrip(config: BadConfig | BadConfigInput) -> BadConfig: ...

__all__: list[str] = ["roundtrip", "ElisaError", "BadConfig"]
