...
class ViewBatch(TypedDict):
    values: list[int]
    text: list[str]
    objects: list[Any]
    bytes: bytes

class ViewBatchInput(Protocol):
    values: Sequence[int]
    text: Sequence[str | bytes]
    objects: Sequence[Any]
    bytes: Sequence[int]

def roundtrip(batch: ViewBatch | ViewBatchInput) -> ViewBatch: ...

def total(batch: ViewBatch | ViewBatchInput) -> int: ...

__all__: list[str] = ["roundtrip", "total", "ElisaError", "ViewBatch"]
