...
def cstr(value: str | bytes) -> str: ...

def sview(value: str | bytes) -> str: ...

def accept_cstr(value: str | bytes) -> int: ...

def accept_sview(value: str | bytes) -> int: ...

__all__: list[str] = ["cstr", "sview", "accept_cstr", "accept_sview", "ElisaError"]
