...
def optional_objects(values: Sequence[Any | None]) -> list[Any | None]: ...

def optional_text(values: Sequence[str | bytes | None]) -> list[str | None]: ...

__all__: list[str] = ["optional_objects", "optional_text", "ElisaError"]
