...
def defaulted(mode: int = 7) -> int: ...

def list_default(modes: Sequence[int] = [2, 7, 8]) -> list[int]: ...

def dict_default(modes: Mapping[int, int] = {1: 7, 2: 8}) -> dict[int, int]: ...

__all__: list[str] = ["defaulted", "list_default", "dict_default", "ElisaError"]
