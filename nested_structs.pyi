...
class ProfileInput(Protocol):
    id: int
    address: Address | AddressInput
    label: str | bytes

def roundtrip(profile: Profile | ProfileInput) -> Profile: ...

def city(profile: Profile | ProfileInput) -> str: ...

__all__: list[str] = ["roundtrip", "city", "ElisaError", "Address", "Profile"]
