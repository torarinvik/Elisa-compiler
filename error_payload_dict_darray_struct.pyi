...
class RowsError(ElisaError):
    payload: dict[int, list[Point]]
...
def fail(rows: Mapping[int, Sequence[Point | PointInput]]) -> int: ...
# raises RowsError
# error payload: dict[int, list[Point]]

__all__: list[str] = ["fail", "RowsError", "ElisaError", "Point"]
