...
def roundtrip(values: Mapping[int, Sequence[int]]) -> dict[int, list[int]]: ...

def roundtrip_bytes(values: Mapping[str | bytes, Sequence[int]]) -> dict[str, bytes]: ...

__all__: list[str] = ["roundtrip", "roundtrip_bytes", "ElisaError"]
