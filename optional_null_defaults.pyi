...
class OptionalDefaults(TypedDict):
...
class OptionalDefaultsInput(Protocol):
    pass
...
def roundtrip(options: OptionalDefaults | OptionalDefaultsInput) -> OptionalDefaults: ...

def defaulted(options: OptionalDefaults | OptionalDefaultsInput = {}) -> OptionalDefaults: ...

def scalar_default(value: int | None = None) -> int | None: ...

__all__: list[str] = ["roundtrip", "defaulted", "scalar_default", "ElisaError", "OptionalDefaults"]
