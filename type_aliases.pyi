...
def identity_id(value: int) -> int: ...

def identity_count(value: int) -> int: ...

def identity_name(value: str | bytes) -> str: ...

def identity_optional(value: int | None = None) -> int | None: ...

def identity_ids(values: Sequence[int]) -> list[int]: ...

def identity_map(values: Mapping[str | bytes, int]) -> dict[str, int]: ...

__all__: list[str] = ["identity_id", "identity_count", "identity_name", "identity_optional", "identity_ids", "identity_map", "ElisaError"]
