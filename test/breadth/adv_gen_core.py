#!/usr/bin/env python3
"""Adversarial differential generators — the first families the harness was written for: overload resolution, generic name
mangling, extern declarations, container literals in value position, numeric edges,
structs and enums, control flow, refs and optionals, casts and strings
...
GENERATORS = [
    gen_overloads,
    gen_generic_mangling,
    gen_externs,
    gen_container_values,
    gen_numeric_edges,
    gen_discard_and_scope,
    gen_structs_enums,
    gen_control_flow,
    gen_refs_optionals,
    gen_casts_arith,
