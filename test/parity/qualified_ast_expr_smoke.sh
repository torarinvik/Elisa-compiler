...
[[ -x "$STAGE0" ]] || { echo "qualified AST expression smoke SKIP: stage0 unavailable"; exit 0; }
[[ -x "$STAGE1" ]] || { echo "qualified AST expression smoke SKIP: stage1 unavailable"; exit 0; }
