...
if ! clang -o "$ROOT/build/easm_template_analysis_smoke" "$ROOT/build/easm_template_analysis_smoke.o" -L"$("$LLVM_CONFIG" --libdir)" -lLLVM -Wl,-rpath,"$("$LLVM_CONFIG" --libdir)"; then
