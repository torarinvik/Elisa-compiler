...
run_negative "via_unknown_permission.neg.elisa" 'unknown permission "NoSuch"'
run_negative "handler_target_via_unknown_permission.neg.elisa" 'unknown permission "NoSuch"'
