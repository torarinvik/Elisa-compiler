...
[[ -x "$STAGE0" ]] || { echo "module packed common namespacing smoke SKIP: stage0 unavailable"; exit 0; }
[[ -x "$STAGE1" ]] || { echo "module packed common namespacing smoke SKIP: stage1 unavailable"; exit 0; }
[[ -f "$RUNTIME_OBJ" ]] || { echo "module packed common namespacing smoke SKIP: runtime object unavailable"; exit 0; }
