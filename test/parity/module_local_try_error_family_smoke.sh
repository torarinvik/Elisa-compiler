...
[[ -x "$STAGE0" ]] || { echo "module-local try error-family smoke FAIL: stage0 unavailable" >&2; exit 1; }
[[ -x "$STAGE1" ]] || { echo "module-local try error-family smoke FAIL: stage1 unavailable" >&2; exit 1; }
